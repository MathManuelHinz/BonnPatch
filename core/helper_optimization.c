...
{
    "distutils": {
        "name": "bonnpatch.core.optimization",
        "sources": [
            "core/helper_optimization.py"
        ]
    },
    "module_name": "bonnpatch.core.optimization"
}
END: Cython Metadata */
...
#define __PYX_HAVE__bonnpatch__core__optimization
#define __PYX_HAVE_API__bonnpatch__core__optimization
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "bonnpatch.core.optimization" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "bonnpatch.core.optimization"
extern int __pyx_module_is_main_bonnpatch__core__optimization;
int __pyx_module_is_main_bonnpatch__core__optimization = 0;

/* Implementation of "bonnpatch.core.optimization" */
...
#define __pyx_n_u_opt __pyx_string_tab[8]
#define __pyx_n_u_optimize __pyx_string_tab[9]
#define __pyx_n_u_qualname __pyx_string_tab[10]
#define __pyx_n_u_scipy __pyx_string_tab[11]
#define __pyx_n_u_scipy_optimize __pyx_string_tab[12]
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_optimization(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'optimization' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "optimization" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_optimization", 0);
  ...
  if (__pyx_module_is_main_bonnpatch__core__optimization) {
  ...
  }
  {
    ...
    if (!PyDict_GetItemString(modules, "bonnpatch.core.optimization")) {
      if (unlikely((PyDict_SetItemString(modules, "bonnpatch.core.optimization", __pyx_m) < 0))) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  /* "core/helper_optimization.py":3
 * 
 * import numpy as np
 * import scipy.optimize as opt             # <<<<<<<<<<<<<<
 * 
*/
  __pyx_t_2 = __Pyx_ImportDottedModule(__pyx_mstate_global->__pyx_n_u_scipy_optimize, __pyx_mstate_global->__pyx_tuple[0]); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_opt, __pyx_t_2) < 0) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init bonnpatch.core.optimization", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init bonnpatch.core.optimization");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
 ...
 * 
*/
  __pyx_mstate_global->__pyx_tuple[0] = PyTuple_Pack(2, __pyx_mstate_global->__pyx_n_u_scipy, __pyx_mstate_global->__pyx_n_u_optimize); if (unlikely(!__pyx_mstate_global->__pyx_tuple[0])) __PYX_ERR(0, 3, __pyx_L1_error)
